 ...
 * Date: Oct-05-2015
 * Purpose: XML WebService for Agencies 
 */
...
public class GetAgenciesXML extends HttpServlet {
			...
			HttpServletResponse response)
	{
	   ...
	   // {
			...
			try {
				...
				ResultSet rs = stmt1.executeQuery("SELECT * FROM agencies");
